...
- Package name: `opengate-gate-macro-fold`
- Source root: `src/opengate_gate_macro_fold`
...
- Ensure tests target current modules from `opengate_gate_macro_fold` (not legacy project names).
